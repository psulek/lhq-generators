...
import {
    ...
    getLibraryVersion, namespaceUtils
} from './index';

import type { GeneratedFile, LhqModel, GeneratorInitialization, FileInfo} from './index'
...
async function saveLhqModelFile(model: LhqModel, fileName: string, fileContent?: string): Promise<void> {
    ...
    const lineEndings = generatorUtils.detectLineEndings(fileContent);
